        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Chips"
              name="sides"
              defaultChecked={ props.sides.includes('Chips') ? true : false }
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Chips & Salsa"
              name="sides"
              defaultChecked={ props.sides.includes('Chips & Salsa') ? true : false}
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Chips & Guac"
              name="sides"
              defaultChecked={ props.sides.includes('Chips & Guac')? true : false }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Chips & Queso"
              name="sides"
              defaultChecked={ props.sides.includes('Chips & Queso')? true : false }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Tortilla"
              name="sides"
              defaultChecked={ props.sides.includes('Tortilla') ? true : false}
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Taco"
              name="sides"
              defaultChecked={ props.sides.includes('Taco') ? true : false}
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              name="sides"
              defaultChecked={ props.sides.includes('Fountain Drink')? true : false }
              onChange={ props.handleChange }
            />
