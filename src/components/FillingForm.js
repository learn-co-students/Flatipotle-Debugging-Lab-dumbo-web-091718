        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="White Rice"
              name="fillings"
              defaultChecked={ props.fillings.includes('White Rice') ? true : false}
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Brown Rice"
              name="fillings"
              defaultChecked={ props.fillings.includes('Brown Rice') ? true : false}
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Black Beans"
              name="fillings"
              defaultChecked={ props.fillings.includes('Black Beans') ? true : false}
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Pinto Beans"
              name="fillings"
              defaultChecked={ props.fillings.includes('Pinto Beans') ? true : false}
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              name="fillings"
              defaultChecked={ props.fillings.includes('Fajita Veggies') ? true : false}
              onChange={ props.handleChange }
            />
