        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              name="toppings"
              defaultChecked={ props.toppings.includes('Mild Hot Sauce') ? true : false}
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              name="toppings"
              defaultChecked={ props.toppings.includes('Medium Hot Sauce')? true : false }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="HOT Hot Sauce"
              name="toppings"
              defaultChecked={ props.toppings.includes('HOT Hot Sauce') ? true : false}
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Corn Salsa"
              name="toppings"
              defaultChecked={ props.toppings.includes('Corn Salsa') ? true : false}
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Sour Cream"
              name="toppings"
              defaultChecked={ props.toppings.includes('Sour Cream') ? true : false}
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Lettuce"
              name="toppings"
              defaultChecked={ props.toppings.includes('Lettuce')? true : false }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Guac"
              name="toppings"
              defaultChecked={ props.toppings.includes('Guac')? true : false }
              onChange={ props.handleChange }
            />
        ...
        <div className="field">
          <div className="ui checkbox">
            <input
              ...
              value="Cheese"
              name="toppings"
              defaultChecked={ props.toppings.includes('Cheese') ? true : false}
              onChange={ props.handleChange }
            />
